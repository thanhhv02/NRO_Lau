...
namespace AssemblyCSharp.Mod.Xmap
{
    public class XmapData
    {
        ...
        { 
            ...
            {
                LoadLinkMapsFromFile("Game\\Game\\TextData\\LinkMapsXmapBlue.txt");
            }else if (ChangeServer.nroS)
            {
                LoadLinkMapsFromFile("Game\\Game\\TextData\\LinkMapsXmapSuper.txt");
            }
            //LoadLinkMapsFromFile("Game\\Game\\TextData\\LinkMapsXmap.txt"); 
            LoadLinkMapsAutoWaypointFromFile("Game\\Game\\TextData\\AutoLinkMapsWaypoint.txt");
            LoadLinkMapsHome();
            LoadLinkMapSieuHangToDaiHoi();
            LoadLinkMapDaiHoiToDaiHoi23(); 
            LoadLinkMapDaiHoi23ToDaiHoi();
            LoadLinkMapDaiHoiToSieuHang(); 
            LoadLinkMapToDoanhTrai();
            LoadLinkMapSieuThi();
            LoadLinkMapToCold();
            LoadLinkMapToKaio();
            LoadLinkMapKaioToThanDien(); 
            LoadLinkMapsThanDien();
            LoadLinkMapKaioToThanhDia();
            LoadLinkMapThanhDiaToKaio();
            LoadLinkMapKaioToBill();
            LoadLinkMapBillToThanhDia();
            LoadLinkMapBillToNgucTu();
        ...
        private void LoadLinkMapToKaio()
        {
            
            const int ID_NPC = 19;
            const int ID_MAP_THAN_DIEN = 45;
            const int ID_MAP_KAIO = 48;
            const int INDEX = 3;
            ...
            LoadLinkMap(ID_MAP_THAN_DIEN, ID_MAP_KAIO, TypeMapNext.NpcMenu, info);
        }
        private void LoadLinkMapKaioToThanDien()
        {
            ...
            LoadLinkMap(ID_MAP_KAIO, ID_MAP_THAN_DIEN, TypeMapNext.NpcMenu, info);
        }
        private void LoadLinkMapKaioToThanhDia()
        {
            
            const int ID_NPC = 20;
            const int ID_MAP_THANH_DIA = 50;
            const int ID_MAP_KAIO = 48;
            const int INDEX = 3;
            ...
            LoadLinkMap(ID_MAP_KAIO, ID_MAP_THANH_DIA, TypeMapNext.NpcMenu, info);
        }
        private void LoadLinkMapThanhDiaToKaio()
        {
            ...
            LoadLinkMap(ID_MAP_THANH_DIA, ID_MAP_KAIO, TypeMapNext.NpcMenu, info);
        }
        private void LoadLinkMapKaioToBill()
        {
            
            const int ID_NPC = 44;
            const int ID_MAP_BILL = 154;
            const int ID_MAP_THANH_DIA = 50;
            const int INDEX = 1;
            ...
            LoadLinkMap(ID_MAP_THANH_DIA, ID_MAP_BILL, TypeMapNext.NpcMenu, info);
        }
        private void LoadLinkMapBillToThanhDia()
        {
            ...
            LoadLinkMap(ID_MAP_BILL, ID_MAP_THANH_DIA, TypeMapNext.NpcMenu, info);
        }
        private void LoadLinkMapBillToNgucTu()
        {
            
            const int ID_NPC = 44;
            const int ID_MAP_BILL = 154;
            const int ID_MAP_NGUC_TU = 155;
            const int INDEX = 1;
            ...
            LoadLinkMap(ID_MAP_BILL, ID_MAP_NGUC_TU, TypeMapNext.NpcMenu, info);
        }

        private void LoadLinkMapsThanDien()
        {
            int ID_KARIN = 47;
            int ID_THANDIEN = 46;
            LoadLinkMap(ID_KARIN, ID_THANDIEN, TypeMapNext.AutoWaypoint, null);
        }
        private void LoadLinkMapDaiHoiToDaiHoi23()
        {
            
            const int ID_NPC = 23;
            const int ID_MAP_DAI_HOI = 52;
            const int ID_MAP_DAI_HOI_23 = 129;
            const int INDEX = 3;
            ...
            LoadLinkMap(ID_MAP_DAI_HOI, ID_MAP_DAI_HOI_23, TypeMapNext.NpcMenu, info);
        }
        private void LoadLinkMapDaiHoi23ToDaiHoi()
        {
            ...
            LoadLinkMap(ID_MAP_DAI_HOI_23, ID_MAP_DAI_HOI, TypeMapNext.NpcMenu, info);
        }
        private void LoadLinkMapDaiHoiToSieuHang()
        {
            const int ID_NPC = 23;
            const int ID_MAP_DAI_HOI = 52;
            const int ID_MAP_SIEU_HANG = 113;
            const int INDEX = 2; 
            ...
            LoadLinkMap(ID_MAP_DAI_HOI, ID_MAP_SIEU_HANG, TypeMapNext.NpcMenu, info);
        }
        private void LoadLinkMapSieuHangToDaiHoi()
        {
            const int ID_NPC = 22;
            const int ID_MAP_DAI_HOI = 52;
            const int ID_MAP_SIEU_HANG = 113;
            ...
            LoadLinkMap(ID_MAP_SIEU_HANG, ID_MAP_DAI_HOI, TypeMapNext.NpcMenu, info);
        }
        private void LoadLinkMapToDoanhTrai() 
        {
            const int ID_NPC = 25;
            const int ID_MAP_DOANH_TRAI = 53;
            const int ID_MAP_BAMBO = 27;
            const int INDEX = 0;
            ...
            LoadLinkMap(ID_MAP_BAMBO, ID_MAP_DOANH_TRAI, TypeMapNext.NpcMenu, info);
        }
        #endregion
