    ...
    public class UseItem
    {
        ...
        public static void usePean()
        {
            try
            {
                ...
                while (PickMob.IsAutoBuffDauTheoSec)
                {
                    GameScr.gI().doUseHP();
                    Thread.Sleep(TimeSpan.FromSeconds(PickMob.SecondBuffTheoSec));
                }
                GameScr.info1.addInfo("Buff đậu sau " + PickMob.SecondBuffTheoSec + "s", 0);
