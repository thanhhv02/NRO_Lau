...
namespace AssemblyCSharp.Mod.Xmap
{
    public class XmapController : IActionListener
    {
        ...
        public static void GoBack()
        {
            ...
            if (TileMap.mapID == global::Char.myCharz().nClass.classId + 21 && PickMobController.IsCompleteGetBean == true)
            {
                Getout();
                return;
            }
            ...
            //if (TileMap.mapID == MapID && TileMap.zoneID == ZoneID && GameCanvas.gameTick % 150 == 0)
            //{
            //    MoveMyChar(cx, cy);
            //}
        }
