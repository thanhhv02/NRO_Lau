...
public class Rms
{
	...
	{
		//mod
		return "Game\\Game\\RMS";
	}
	public static string GetiPhoneDocumentsPathLvL2()
	{
		//mod
		return "Game\\Game\\RMSLVL2";
	}
	...
	private static void __saveRMS(string filename, sbyte[] data)
	{
        ...
        {
			string text = GetiPhoneDocumentsPathLvL2() + "/" + filename;
	...
	private static sbyte[] __loadRMS(string filename)
	{
		try
		{
			...
			if (mGraphics.zoomLevel == 2)
            {
				FileStream fileStream = new FileStream(GetiPhoneDocumentsPathLvL2() + "/" + filename, FileMode.Open);
	...
	public static void clearAll()
	{
		...
		//mod
		FileInfo[] files2 = new DirectoryInfo(GetiPhoneDocumentsPathLvL2() + "/").GetFiles();
	...
	public static void DeleteStorage(string path)
	{
		try
		{
			...
			//mod
			File.Delete(GetiPhoneDocumentsPathLvL2() + "/" + path);
		}
		catch (Exception)
		{
		}
